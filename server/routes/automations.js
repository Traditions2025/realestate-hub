...
function fillMerge(text, c) {
  ...
  return String(text)
    ...
    .replace(/\{\{price_point\}\}/g, (c.fub_price_point ? String(c.fub_price_point).trim() : ''))
    .replace(/\{\{price_range\}\}/g, (c.fub_price_point ? ` in the ${String(c.fub_price_point).trim()} range` : ''))
    .replace(/\{\{price_clause\}\}/g, (c.fub_price_point ? ` in the ${String(c.fub_price_point).trim()} range` : ''))

...
const FIELDS = [
  ...
  'ayse_contracts_signed', 'earnest_money_deposit', 'earnest_money_amount', 'home_inspection', 'home_inspector',
...

{
  ...
  "earnest_money_amount": string (the earnest money dollar amount exactly as written, e.g. "$2,500"),
